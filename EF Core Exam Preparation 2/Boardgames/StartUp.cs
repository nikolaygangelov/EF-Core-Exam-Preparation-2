namespace Boardgames
{
    ...
    public class StartUp
    {
        ...
        {
            var exportCreatorsWithTheirBoardgames = Serializer.ExportCreatorsWithTheirBoardgames(context);
            ...
            var year = 2021;
            double rating = 9.50;
            var exportSellersWithMostBoardgames = Serializer.ExportSellersWithMostBoardgames(context, year, rating);
